...
namespace DVLD.Tests
{
    public partial class frmListLocalDrivingLicesnseApplications : Form
    {
        ...
        private void scheduleStreetTestToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if ((int)dgvLocalDrivingLicenseApplications.CurrentRow.Cells[5].Value==3)
            {
                clsApplication application = clsApplication.FindBaseApplication((clsLocalDrivingLicenseApplication.FindByLocalDrivingAppLicenseID
                   ((int)dgvLocalDrivingLicenseApplications.CurrentRow.Cells[0].Value).ApplicationID));
